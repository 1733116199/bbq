...
export PRECISION=$1
export W_QUANT="StretchedElasticQuantizer"
export A_QUANT="StretchedElasticQuantizer"
export W_QUANT_KWARGS="{\"bits\": $PRECISION, \"channels\": 0}"
export A_QUANT_KWARGS="{\"bits\": $PRECISION, \"weight_layerwise\": true}"
...
WANDB_PREFIX="GPT-${MODEL_SIZE_PREFIX}-${W_QUANT}@${PRECISION}:${A_QUANT}@${PRECISION}-${DATASET}"
