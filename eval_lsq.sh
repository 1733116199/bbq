...
torchrun --nproc_per_node=${NUM_GPUS} ./src/main.py \
    ...
    --dataset "wikitext" \
    --resume-from exps/NEW-100M-LSQQuantizer@${PRECISION}:LSQQuantizer@${PRECISION}-c4_c4_llama_nlayers8_nhead8_lr0.0006_sched_cos_warmup3814_decay_linear_0.1_iter38146_bs64x8_ws1_seed0_data_seed1337/ckpts/latest \
    --w-quant ${W_QUANT} \
