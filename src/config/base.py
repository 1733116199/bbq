...
def parse_args(base_parser, args, namespace):
    ...
    # Optimization
    parser.add_argument("--opt", default="adamw", choices=["adamw", "sgd", "SFAdamW", "none"])
    ...
    parser.add_argument(
        "--realquant", type=int, default=0
    )
    parser.add_argument(
        "--realquanttype", type=str, default="fp4", choices=["fp4", "int4"]
    )

    parser.add_argument(
        "--profile_start", type=int, default=1000000
    )
    parser.add_argument(
        "--profile_end", type=int, default=1000000
    )
