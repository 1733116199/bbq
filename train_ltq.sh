...
export W_QUANT="LTQW"
export A_QUANT="LTQ"
export W_QUANT_KWARGS="{\"num_bits\": $PRECISION}"
export A_QUANT_KWARGS="{\"num_bits\": $PRECISION}"
...
WANDB_PREFIX="GPT-${MODEL_SIZE_PREFIX}-${W_QUANT}@${PRECISION}@${2}:${A_QUANT}@${PRECISION}@${2}-${DATASET}"
