...
WANDB_PREFIX="TEST-LLAMA-${MODEL_SIZE_PREFIX}-${W_QUANT}@${PRECISION}@${2}:${A_QUANT}@${PRECISION}@${2}-${DATASET}"
...
torchrun --nproc_per_node=${NUM_GPUS} ./src/main.py \
    ...
    --eval_uncompiled 1 \
    --realquant 1 \
    --resume-from exps/LLaMA-EMA-30M-BBQV5HDChan@3@0:BBQV5HD@3@0-c4_c4_llama_nlayers6_nhead5_lr0.0012_sched_cos_warmup1144_decay_linear_0.1_iter11444_bs64x8_ws1_seed0_data_seed1337/ckpts/latest \
    --w-quant ${W_QUANT} \
